...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_dir", type=str,default = "logs/AttnWGAIN/AUC", help="model and log saving dir")
    parser.add_argument(
    ...
    parser.add_argument(  
        "--saved_model_path",  
        type=str,  
        default="logs/AttnWGAIN/AUC/models/2024-11-03_T10-49-11/model_epoch_10_ROCAUC_0.8618",
